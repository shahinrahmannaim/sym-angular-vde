...
class getRecipeRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\RecipeRepository'])) {
            return $container->privates['App\\Repository\\RecipeRepository'];
        }

        return $container->privates['App\\Repository\\RecipeRepository'] = new \App\Repository\RecipeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
