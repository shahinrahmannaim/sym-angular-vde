...
class getApiSignupControllerregisterService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->privates['.service_locator.__CzQUd.App\\Controller\\API\\ApiSignupController::register()'] = (new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'entityManager' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
            'passwordHasher' => ['privates', 'security.user_password_hasher', 'getSecurity_UserPasswordHasherService', true],
        ], [
            'entityManager' => '?',
            'passwordHasher' => '?',
        ]))->withContext('App\\Controller\\API\\ApiSignupController::register()', $container);
    }
}
