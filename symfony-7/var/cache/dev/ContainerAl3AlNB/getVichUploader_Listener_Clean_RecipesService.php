 ...
 */
class getVichUploader_Listener_Clean_RecipesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.recipes' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.recipes'])) {
            return $container->privates['vich_uploader.listener.clean.recipes'];
        }

        return $container->privates['vich_uploader.listener.clean.recipes'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('recipes', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
