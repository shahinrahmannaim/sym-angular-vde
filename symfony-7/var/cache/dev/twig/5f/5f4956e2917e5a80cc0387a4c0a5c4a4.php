...
class __TwigTemplate_20bc6f8d3375e4af58abb19cab8a14d0 extends Template
{
   ...
   <div class=\"col-sm\"> ";
        // line 11
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "name", [], "any", false, false, false, 11), 'row');
        yield " </div>
   <div class=\"col-sm\"> ";
        // line 12
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "email", [], "any", false, false, false, 12), 'row');
        yield " </div>
   <div class=\"col-sm\"> ";
        // line 13
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "service", [], "any", false, false, false, 13), 'row');
        yield " </div>
...
";
    ...
    {
        return array (  126 => 18,  118 => 13,  114 => 12,  110 => 11,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<h1>Nous Contacter</h1>
   ...
   <div class=\"col-sm\"> {{ form_row(form.service) }} </div>
   ...
   {{ form_end(form) }}
{% endblock %}
", "contact/contact.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/symfony-7/templates/contact/contact.html.twig");
    }
}
